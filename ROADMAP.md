...
**当前状态（2026-09-27）**：**92 个测试类 / 842 个用例全绿**；demo 跑通一场三对三战斗
...
- **忆灵**（面板快照自召唤者、连携攻击）—— 现在**有地方放了**（`allies`），但缺那两条机制。
